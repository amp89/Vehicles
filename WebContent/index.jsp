    ...
    <header id="index-header">
        <div class="header-content">
            <div class="header-content-inner">
                ...
                <button type ="submit" name="selection" value="range" class="btn btn-success btn-xl page-scroll">Search/Update/Remove</button>
                <button type ="submit" name="selection" value="add" class="btn btn-success btn-xl page-scroll">Add Vehicle</button>
                <button type ="submit" name="selection" value="all" class="btn btn-success btn-xl page-scroll">List All Vehicles</button>
